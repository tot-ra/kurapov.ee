...
аутентификация = подтверждение личности пользователя, от англ. authentic = настоящий, подлинный  
авторизация = разрешение на действия

OAuth занимается именно авторизацией (разрешением действий приложению благодаря токену), но не запрашиваемыми привилегиями или последующими действиями через API. Аутентификацию должна выполнять сама социальная сеть.
