...
const config: Config = {
  title: 'Артём Курапов',
  tagline: 'Наблюдения и размышления раба Божьего, Артёма о жизни, кибернетике, философии, науке и религии в современном обществе потребления и технологического прогресса современной Эстонии',
